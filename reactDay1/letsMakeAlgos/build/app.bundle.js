...
var calculateAnswer = function calculateAnswer(answer) {};
...
var Header = createReactClass({
    ...
    render: function render() {
        return React.createElement(
            ...
            React.createElement(ShowAlgo, null)
        );
    }
});

var ShowAlgo = createReactClass({
    displayName: 'ShowAlgo',

    render: function render() {
        var algos = ["Loop through a array that counts to 100", "Don't Loop tthrough a array that counts to 100", "How do you loop thorugh a array?"];
...
var AnswerQuestion = createReactClass({
    ...
    answerChange: function answerChange(event) {
        ...
        return React.createElement(
            ...
            React.createElement(
                ...
                React.createElement(
                    ...
                    React.createElement('textarea', { name: '', id: '', cols: '170', rows: '30', value: this.state.answer, onChange: this.answerChange })
                )
            )
        );
    }
        ...
        var items = this.props.data.map(function (year, index) {
            ...
            return React.createElement(
                ...
                React.createElement(
                    ...
                    year.principalY.toFixed(2).toLocaleString()
                ),
                React.createElement(
                    'td',
                    { className: 'stretch' },
                ...
                React.createElement(
                    ...
                    year.interestY.toFixed(2).toLocaleString()
                ),
                React.createElement(
                    'td',
                    { className: 'currency' },
                    year.balance.toFixed(2).toLocaleString()
                )
            );
        });
        return React.createElement(
...
var App = createReactClass({
    ...
    render: function render() {
        return React.createElement(
            'div',
            null,
            React.createElement(Header, { title: 'Algorithim question maker' }),
            React.createElement(AnswerQuestion, { answer: 'code your algo here' }),
